...
"""
===================================
A股自选股智能分析系统 - Config 主类
===================================

职责：
1. Config dataclass（单例模式）
2. get_config() 便捷函数
3. setup_env() 初始化函数
"""
...
from src.config.constants import ConfigIssue as _ConfigIssue

ConfigIssue = _ConfigIssue  # re-export for backward compat
